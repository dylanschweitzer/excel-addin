        ...
        public static async Task<UpdateCheckResult> CheckForUpdatesAsync()
        {
            ...
            try
            {
                using (var client = new HttpClient())
                {
                    ...
                    if (release.TryGetValue("tag_name", out var tagName) && tagName != null)
                    {
                        result.LatestVersion = tagName.ToString();
                    }

                    if (release.TryGetValue("html_url", out var htmlUrl) && htmlUrl != null)
                    {
                        result.ReleaseUrl = htmlUrl.ToString();
                    }
